...
(function () {
  const FR = {
    ...
    tl3_title: 'Développeur Web Freelance — Missions Clients',
    tl3_desc: "Missions pour des agences et des entreprises locales : plateformes web sur mesure et outils internes. API Symfony, frontends Vue et JS — et l'apprentissage du cadrage, du devis et des délais fixés par quelqu'un d'autre.",
    tl4_title: 'Premiers Contrats & Open Source',
    tl4_desc: "Un début en autodidacte à Yaoundé : premiers sites payés, premières pull requests open source, premières factures. Pas d'employeur, pas de filet — juste l'habitude qui n'est jamais partie : livrer, casser, réécrire en mieux.",
    // lab
