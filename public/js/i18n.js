...
(function () {
  const FR = {
    ...
    hero_sub: 'Développeur Full-Stack<span>/</span>Systèmes IA<span>/</span>Technologue Créatif',
    ...
    pcat_schoolx: 'SaaS scolaire · En vedette',
    pdesc_schoolx: "Une plateforme de gestion scolaire multi-locataire pour les écoles francophones — notes, emplois du temps et bulletins dans un seul espace à votre marque, avec votre domaine et votre langue, et des bulletins générés par IA.",
    pcat_chatflow: 'Temps réel · Web',
    ...
    journey_sub: "Quatre ans de freelance professionnel, zéro employeur — précédés des années d’apprentissage qui les ont rendues possibles. Des contrats choisis, une architecture assumée, et une responsabilité directe envers ceux qui paient.",
    tl_before: 'AVANT 2022',
    ...
    tl2_title: 'Développeur Produit Freelance — SaaS & Plateformes',
    tl2_desc: "Des produits clients menés du dépôt vide à la production : messagerie temps réel, plateformes de quiz et d'e-learning, dashboards internes. Architecture, authentification, modèle de données, déploiement — et l'astreinte qui va avec.",
    tl3_title: 'Apprendre en public, et les premiers contrats payés',
    tl3_desc: "Un début en autodidacte à Yaoundé : premiers sites payés, premières pull requests open source, premières factures. Puis des missions pour des agences et des entreprises locales — API Symfony, frontends Vue et JS — et l’apprentissage du cadrage, du devis et des délais fixés par quelqu’un d’autre. Les années qui ont formé le métier, avant qu’il ne devienne le travail.",
    // lab
