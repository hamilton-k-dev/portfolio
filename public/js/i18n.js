...
(function () {
  const FR = {
    ...
    pcat_aether: 'Plateforme IA · En vedette',
    pdesc_aether: "Une plateforme no-code pour construire des agents IA autonomes. Constructeur de pipelines visuel, mémoire RAG et couche d'orchestration multi-modèles traitant plus de 12k exécutions quotidiennes en moins d'une seconde.",
    pdesc_nimbus: "Tableau de bord de trésorerie en temps réel traitant plus de 2M de transactions/jour avec détection d'anomalies en direct.",
    pcat_tooling: 'Outillage',
    pdesc_forge: 'Outil de scaffolding pour développeurs. Plus de 8k installations npm hebdomadaires.',
    pdesc_lumen: 'Expérience e-commerce headless avec configurateur produit 3D et paiement en moins d\u2019une seconde.',
    pcat_sentinel: 'IA · Automatisation',
    pdesc_sentinel: "Bot autonome de réponse aux incidents qui trie les alertes et rédige les post-mortems.",
