...
(function () {
  ...
  let offsetX = 0,
    offsetXTarget = 0; // responsive rightward shift of the centerpiece
  ...
  function applyAccentColors() {
    ...
    if (crystal) {
      crystal.material.color = accent;
      crystalGlow.material.color = accent;
    }
  ...
  window.HeroScene = {
    ...
    setAccent(hex, hex2) {
      ...
      if (hex2) accent2 = new THREE.Color(hex2);
      applyAccentColors();
    },
    setMotion(v) {
      motion = v;
    ...
    setScroll(v) {
      scrollP = Math.max(0, Math.min(1, v));
    },
  };
})();
